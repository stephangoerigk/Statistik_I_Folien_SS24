...
##### `r format(as.Date(data.frame(readxl::read_excel("Modul Quantitative Methoden I_Termine.xlsx"))$Datum), "%d.%m.%Y")[3]` | Prof. Dr. phil. Stephan Goerigk
...
$$q_{0.25} = x_{(I_{0.25})} = x_{(4)} = 6$$
$$q_{0.75} = x_{(I_{0.75})} = x_{(12)} = 12$$
$$q_{A}= \widetilde{x}_{0.75} - \widetilde{x}_{0.25} = 12 - 6 = 6$$
...
$$q_{0.25} = \frac{x_{(I_{0.25})} + x_{(I_{0.25}+1)}}{2} = \frac{x_{(5)} + x_{(6)}}{2} = \frac{7 + 9}{2} = 8$$
